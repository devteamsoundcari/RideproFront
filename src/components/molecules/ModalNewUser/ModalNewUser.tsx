...
export function ModalNewUser({ handleClose }: IModalNewUserProps) {
  ...
  const showErrorMessage = () => {
    if (userErrorMessage) {
      return (
        <small>
          Oops! Al parecer el email <strong>{userErrorMessage}</strong> ya está registrado :(
        </small>
      );
    } else {
      return '';
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Form.Row>
            ...
            <Form.Group as={Col}>
              ...
              <Form.Text>
                {errors.lastName && (
                  <span className="text-danger">Ingrese un apellido válido.</span>
                )}
              </Form.Text>
            </Form.Group>
          </Form.Row>
            ...
            <Form.Group as={Col}>
              ...
              <Form.Text className="text-muted">
                ...
                {errors.passwordRepeat && (
                  <span className="text-danger">Confirma la contraseña</span>
                )}
              </Form.Text>
